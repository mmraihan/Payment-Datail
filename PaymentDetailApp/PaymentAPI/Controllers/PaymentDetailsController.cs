...
namespace PaymentAPI.Controllers
{
    ...
    public class PaymentDetailsController : ControllerBase
    {
        ...
        {
            if (id != paymentDetail.PaymentDetyailId)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<PaymentDetail>> PostPaymentDetail(PaymentDetail paymentDetail)
        {
            ...
            {
                if (PaymentDetailExists(paymentDetail.PaymentDetyailId))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetPaymentDetail", new { id = paymentDetail.PaymentDetyailId }, paymentDetail);
        }
        ...
        {
            return _context.PaymentDetails.Any(e => e.PaymentDetyailId == id);
        }
    }
}
